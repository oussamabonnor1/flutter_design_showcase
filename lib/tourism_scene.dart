...
class StarLayout extends StatefulWidget {
  @override
  StarLayoutState createState() => StarLayoutState();
}

class StarLayoutState extends State<StarLayout> {
